...
def get_images(url):
    ...
    #         error_counter += 1
    #     print("failed :" + (str)(error_counter))

# get_images(url)

# works for some url some dont
